...
datasets = 'rd_ausio2_ausio2' # fake_real
n_classes = 2
...
data3 = np.load('../rd_tipAu_SiO2_morl.npz')['wavelets']
...
data_rd_ausio2 = data3 / data3.max()
...
data = torch.concatenate([data_ausio2, data_rd_ausio2])
